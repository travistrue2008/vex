...
impl Vector2 {
    ...
    /// ```
    /// use vex::Vector2;
    /// let actual = Vector2::construct(1.0, 2.0);
    /// let expected = Vector2 { x: 1.0, y: 2.0 };
    /// assert_eq!(actual, expected);
    /// ```
    pub fn construct(x: f32, y: f32) -> Vector2 {
        Vector2 { x, y }
    }
    ...
    /// ```
    /// use vex::Vector2;
    /// let a = Vector2::construct(1.0, 0.0);
    /// let b = Vector2::construct(0.0, 1.0);
    ...
    /// use vex::Vector2;
    /// let s = 1.0;
    /// let v = Vector2::construct(1.0, 0.0);
    /// let actual = Vector2::cross_scalar_vec(s, &v);
    /// let expected = Vector2::construct(0.0, 1.0);
    /// assert_eq!(actual, expected);
    /// ```
    pub fn cross_scalar_vec(s: f32, v: &Vector2) -> Vector2 {
        Vector2::construct(-s * v.y, s * v.x)
    }
    ...
    /// ```
    /// use vex::Vector2;
    /// let a = Vector2::construct(1.0, 4.0);
    /// let b = Vector2::construct(2.0, 3.0);
    /// let actual = Vector2::min(&a, &b);
    /// let expected = Vector2::construct(1.0, 3.0);
    /// assert_eq!(actual, expected);
    /// ```
    pub fn min(a: &Vector2, b: &Vector2) -> Vector2 {
        Vector2::construct(a.x.min(b.x), a.y.min(b.y))
    }
    ...
    /// let expected = Vector2::construct(2.0, 4.0);
    /// assert_eq!(actual, expected);
    /// ```
    pub fn max(a: &Vector2, b: &Vector2) -> Vector2 {
        Vector2::construct(a.x.max(b.x), a.y.max(b.y))
    }
    ...
    /// ```
    /// use vex::Vector2;
    /// let a = Vector2::construct(1.0, 3.0);
    /// let b = Vector2::construct(2.0, 4.0);
    /// let mut actual = Vector2::construct(0.0, 5.0);
    /// actual.clamp(&a, &b);
    /// let expected = Vector2::construct(1.0, 4.0);
    /// assert_eq!(actual, expected);
    /// ```
    ...
    /// actual.set(1.0, 2.0);
    /// let expected = Vector2::construct(1.0, 2.0);
    /// assert_eq!(actual, expected);
    /// ```
    ...
    /// ```
    /// use vex::Vector2;
    /// let mut actual = Vector2::construct(1.0, 2.0);
    //  actual.zero();
    ...
    /// ```
    /// use vex::Vector2;
    /// let actual = Vector2::construct(1.0, 2.0).magnitude();
    ...
    /// ```
    /// use vex::Vector2;
    /// let actual = Vector2::construct(1.0, 2.0).magnitude_squared();
    /// let expected = 5.0;
    /// assert_eq!(actual, expected);
    /// ```
    ...
    /// let mut actual = Vector2::construct(1.0, 2.0);
    /// actual.normalize();
    /// let expected = Vector2::construct(0.4472135955, 0.894427191);
    /// assert_eq!(actual, expected);
    /// ```
    ...
    /// let mut actual = Vector2::construct(1.0, 2.0);
    /// actual.skew();
    /// let expected = Vector2::construct(-2.0, 1.0);
    /// assert_eq!(actual, expected);
    /// ```
...
impl ops::Index<u32> for Vector2 {
    ...
    /// ```
    /// use vex::Vector2;
    /// let mut v = Vector2::construct(1.0, 2.0);
    /// assert_eq!(v[0], 1.0);
    /// assert_eq!(v[1], 2.0);
    /// ```
...
impl ops::Neg for Vector2 {
    ...
    /// ```
    fn neg(self) -> Vector2 {
        Vector2::construct(-self.x, -self.y)
    }
}
...
impl ops::Add<f32> for Vector2 {
    ...
    /// ```
    /// use vex::Vector2;
    /// let actual = Vector2::construct(1.0, 2.0) + 1.0;
    /// let expected = Vector2::construct(2.0, 3.0);
    /// assert_eq!(actual, expected);
    /// ```
    fn add(self, _rhs: f32) -> Vector2 {
        Vector2::construct(self.x + _rhs, self.y + _rhs)
    }
}
...
impl ops::Add<Vector2> for Vector2 {
    ...
    /// ```
    /// use vex::Vector2;
    /// let a = Vector2::construct(1.0, 2.0);
    /// let b = Vector2::construct(3.0, 4.0);
    /// let actual = a + b;
    /// let expected = Vector2::construct(4.0, 6.0);
    /// assert_eq!(actual, expected);
    /// ```
    fn add(self, _rhs: Vector2) -> Vector2 {
        Vector2::construct(self.x + _rhs.x, self.y + _rhs.y)
    }
}
...
impl ops::AddAssign<f32> for Vector2 {
    ...
    /// let mut actual = Vector2::construct(1.0, 2.0);
    /// actual += 10.0;
    /// let expected = Vector2::construct(11.0, 12.0);
    /// assert_eq!(actual, expected);
    /// ```
...
impl ops::AddAssign<Vector2> for Vector2 {
    ...
    /// use vex::Vector2;
    /// let mut actual = Vector2::construct(1.0, 2.0);
    /// actual += Vector2::construct(1.0, 2.0);
    /// let expected = Vector2::construct(2.0, 4.0);
    /// assert_eq!(actual, expected);
    /// ```
...
impl ops::Sub<f32> for Vector2 {
    ...
    /// ```
    /// use vex::Vector2;
    /// let actual = Vector2::construct(1.0, 2.0) - 10.0;
    /// let expected = Vector2::construct(-9.0, -8.0);
    /// assert_eq!(actual, expected);
    /// ```
...
impl ops::Sub<Vector2> for Vector2 {
    ...
    /// use vex::Vector2;
    /// let a = Vector2::construct(1.0, 2.0);
    /// let b = Vector2::construct(4.0, 3.0);
    /// let actual = a - b;
    /// let expected = Vector2::construct(-3.0, -1.0);
    /// assert_eq!(actual, expected);
    /// ```
...
impl ops::Mul<f32> for Vector2 {
    ...
    /// ```
    /// use vex::Vector2;
    /// let actual = Vector2::construct(1.0, 2.0) * 2.0;
    /// let expected = Vector2::construct(2.0, 4.0);
    /// assert_eq!(actual, expected);
    /// ```
...
impl ops::Mul<Vector2> for Vector2 {
    ...
    /// let b = Vector2::construct(2.0, 3.0);
    /// let actual = a * b;
    /// let expected = Vector2::construct(2.0, 6.0);
    /// assert_eq!(actual, expected);
    /// ```
...
impl ops::MulAssign<Vector2> for Vector2 {
    ...
    /// use vex::Vector2;
    /// let mut actual = Vector2::construct(1.0, 2.0);
    /// actual *= Vector2::construct(2.0, 3.0);
    /// let expected = Vector2::construct(2.0, 6.0);
    /// assert_eq!(actual, expected);
    /// ```
...
impl ops::Div<f32> for Vector2 {
    ...
    /// use vex::Vector2;
    /// let actual = Vector2::construct(1.0, 2.0) / 2.0;
    /// let expected = Vector2::construct(0.5, 1.0);
    /// assert_eq!(actual, expected);
    /// ```
...
impl ops::Div<Vector2> for Vector2 {
    ...
    /// use vex::Vector2;
    /// let a = Vector2::construct(1.0, 2.0);
    /// let b = Vector2::construct(2.0, 8.0);
    /// let actual = a / b;
    /// let expected = Vector2::construct(0.5, 0.25);
    /// assert_eq!(actual, expected);
    /// ```
...
impl ops::DivAssign<Vector2> for Vector2 {
    ...
    /// use vex::Vector2;
    /// let mut actual = Vector2::construct(1.0, 2.0);
    /// actual /= Vector2::construct(2.0, 8.0);
    /// let expected = Vector2::construct(0.5, 0.25);
    /// assert_eq!(actual, expected);
    /// ```
